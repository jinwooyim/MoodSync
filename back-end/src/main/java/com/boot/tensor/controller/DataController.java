...
public class DataController {
	...
	public ResponseEntity<Map<String, Object>> getTrainingData() {
		...
		Double[][] features = {
				// 여성 데이터
				{ 150.0, 45.0 }, { 155.0, 48.0 }, { 160.0, 50.0 }, { 162.0, 52.0 }, { 165.0, 55.0 }, { 158.0, 47.0 },
				{ 163.0, 53.0 }, { 157.0, 49.0 }, { 161.0, 51.0 }, { 159.0, 48.0 },

				// 남성 데이터
				{ 170.0, 65.0 }, { 175.0, 70.0 }, { 180.0, 80.0 }, { 185.0, 85.0 }, { 172.0, 68.0 }, { 178.0, 75.0 },
				{ 183.0, 82.0 }, { 176.0, 72.0 }, { 181.0, 78.0 }, { 174.0, 69.0 } };
