// components/EmotionSliderCard.tsx
'use client';

import React, { useState, useEffect } from 'react';
import { Card, CardContent } from "@/components/ui/card";
import { Sparkles, SlidersHorizontal, ArrowLeft } from 'lucide-react'; // 아이콘 임포트 (Sparkles, ArrowLeft 추가)
import { Slider } from "@/components/ui/slider";
import { Emotion } from "@/types"; // Emotion 타입 임포트
...
export default function EmotionSliderCard({
  ...
  }, [selectedEmotionData?.id]); // selectedEmotionData.id가 변경될 때마다 실행
