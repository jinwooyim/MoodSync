...
export default function BookRecommendationCard({
  ...
  const handleDetailClick = () => {
    const searchUrl = `https://www.nl.go.kr/NL/contents/search.do?kwd=${encodeURIComponent(book.title)}`
  ...
  return (
    ...
    >
      ...
      <CardContent>
        <Badge
          variant="secondary"
          className="bg-gray-100 dark:bg-gray-600 text-gray-700 dark:text-gray-200 transition-colors duration-300 mb-3"
        >
          {book.genre}
        </Badge>
        {book.description && (
        ...
        <div className="flex space-x-2">
          ...
          <Button
            className="w-full border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-300"
            variant="outline"
            onClick={() => onAddToCollection(book, "book")}
          >
