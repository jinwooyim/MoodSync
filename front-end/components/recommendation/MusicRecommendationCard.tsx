  ...
  return (
    ...
    >
      ...
      <CardContent>
        <Badge
          variant="secondary"
          className="bg-gray-100 dark:bg-gray-600 text-gray-700 dark:text-gray-200 transition-colors duration-300"
        >
          {music.genre}
        </Badge>
        <div className="flex space-x-2 mt-4">
          {video?.videoUrl ? (
            <a
              ...
              className="w-full inline-flex items-center justify-center px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-300"
            >
            ...
            <Button
              className="w-full border-gray-300 dark:border-gray-600 text-gray-500 dark:text-gray-400 transition-colors duration-300"
              variant="outline"
              disabled
            >
              <Music className="w-4 h-4 mr-2" />
          ...
          <Button
            className="w-full border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-300"
            variant="outline"
            onClick={() => onAddToCollection(music, "music")}
          >
